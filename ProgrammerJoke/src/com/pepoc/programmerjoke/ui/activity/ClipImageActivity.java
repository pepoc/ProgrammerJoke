...
import com.pepoc.programmerjoke.ui.views.clipimage.CropImage;
import com.pepoc.programmerjoke.ui.views.clipimage.CropImageView;
...
public class ClipImageActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPath = intent.getStringExtra("picturePath");
	...
	public void init() {
		...
		try {
			...
			int degree = BitmapUtil.readBitmapDegree(mPath);
			mBitmap = BitmapUtil.createBitmap(mPath, mScreenWidth, mScreenHeight);
			if (0 != degree) {
				mBitmap = BitmapUtil.rotateBitmap(degree, mBitmap);
			}
